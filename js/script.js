...
function displayCards() {
    ...
    for(let i=0; i<pairsСards.length; i++) {
        ...
        cardsBack[i].setAttribute('data-tid', 'Card-flipped');
...
function matchChecker() {
    ...
    if (images[0].src ==  images[1].src) { 
        images[0].removeAttribute('data-tid', 'Card');
        images[1].removeAttribute('data-tid', 'Card');
        ...
        images[0].removeAttribute('data-tid', 'Card');
        images[1].removeAttribute('data-tid', 'Card');
        images[0].setAttribute('data-tid', 'Card-flipped');
        images[1].setAttribute('data-tid', 'Card-flipped');
